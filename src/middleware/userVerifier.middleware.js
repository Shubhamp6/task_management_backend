...
const userVerifier = async (req, res, next) =>
{
    ...
    try
    {
        ...
        } else
        {
            ...
            if (!((requestedUser.parent_id && Array.isArray(requestedUser.parent_id) &&requestedUser.parent_id.includes(req.user._id)) || req.user.role == USER_ROLES.hr|| req.user.role == USER_ROLES.admin)) {
